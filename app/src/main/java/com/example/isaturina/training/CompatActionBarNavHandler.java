...
public class CompatActionBarNavHandler implements TabListener, OnNavigationListener {
    ...
    com.example.isaturina.training.CompatActionBarNavListener mNavListener;
     ...
     */
    public CompatActionBarNavHandler(com.example.isaturina.training.CompatActionBarNavListener listener) {
